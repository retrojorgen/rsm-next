    ...
    <div className="pink-background container">
      <div className="row">
        ...
        <div className="info-container">
          ...
          <p>
            For femte år på rad arrangerer vi Retrospillmessen i Runarhallen i Sandefjord. Med rundt 100 spillbare retrokonsoller og maskiner, barneaktiviteter, fantastiske gjester og et stort marked med retrospill og merch er Retrospillmessen et av <strong>årets største happenings for gamere i alle aldre!</strong>
          </p>
        </div>
      </div>
    </div>
    <div className="pink-background container reverse">
      <div className="row">
        ...
        <div className="info-container">
          ...
          <p>
            I Retrospillmessen er vi opptatt av familie, og Retrospillmessen er et trygt og trivelig opplevelsessenter for hele familien.
          </p>
          <p>
             Vi har eget barneområde med perling og barneaktiviteter, i tillegg elsker de større ungene å teste alle tv-spillene vi har utstilt. For ikke å snakke om LEGO, rare roboter, og mye annet rart. Vi har egen kantine hvor du får kjøpt mat, det er romslig for barnevogn, og vi har selvsagt også <strong>reduserte priser for barn</strong>. <br /><br /> Et barne-dagspass til Retrospillmessen <strong>koster faktisk mindre enn en kinobillett.</strong>
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="green-background container reverse">
      <div className="row">
        ...
        <div className="info-container">
          ...
          <h4>Åpningstider:</h4>
          <p> Lørdag 22.juni: 10:00-18:00 <br />
              Søndag 23.juni: 10:00-18:00 </p>
          <h4>Reise:</h4>
          <p>
            Retrospillmessen arrangeres i Runarhallen i Sandefjord, Klavenesveien 20. 
            Kjører du bil er det bare en kjapp avkjøring fra E18,
            og kommer du med tog tar du buss 01 fra stasjonen. Det tar ca 40 minutter å gå fra stasjonen.

            <a href="ttps://www.google.no/maps/place/Runarhallen/@59.1486775,10.1854385,17z/data=!3m1!4b1!4m5!3m4!1s0x4646c0d946585e91:0x44ab2add79b2fdf9!8m2!3d59.1486775!4d10.1854386?hl=no">Google maps retninger her.</a>
          </p> 
          <h4>Overnatting:</h4>
          <p> 
    ...
    <div className="green-background container">
      <div className="row">
        ...
        <div className="info-container">
          ...
          <p>I fjor fikk vi besøk av Neo Geo-gjengen for første gang, og nå kommer de tilbake med en ny turnering. På lørdag (22. juni) skal det kjempes om finaleplass i Neo Geo World Championship i Hong Kong. Du kan vinne en plass på Retrospillmessen!</p>
          <p>Det vil foregå to turneringer; en i spillet King of Fighters 98 (Nintendo Switch / Neo Geo), og en i King Of Fighters XIV (PS4).</p>
          <p>Du kan melde deg på turneringene <a href="https://l.facebook.com/l.php?u=https%3A%2F%2Fchallonge.com%2Fevents%2Fngwt2norway%3Ffbclid%3DIwAR1Zmx5Tac2o-uWIE3OgKUJVeyMAQ_T6fYGRK0wwnpXyoUeeQuKgf9Cqo6w&h=AT2rhee5uXIIv_G3VoaCIl0nTLuFiogOU9xRNc1cIYUwNmuzNRcMsjZIY4bpBPDgh5O_5bGPqKg4eaMhJGcqkE1DUqCEkHLKUznrydBkUpKBhkwirdv-tP1BjL8dhOZyBoUqRxskxUn4q_M2EAm2MQW_cFDd8xQtZudAcYNUuMHrasVehVzCaKUGwF8M5-IqyXTVtMl5_RgexGT_EPQIUlWvXeusxYW5MBZTF1MN12bhW7mEGYRI2Ed8chVChD3mlFIxi2lrvC1E7-eC8IsPPfIqT_1KrZjQbFyY5Oi7AZpaAS9KdTZ04Az8g2blhZUCqvGe0lZJjVgS8AmIQ853vKjw3JmYy6L22Ym5rfimds2FzXTLM_JwgZn0VVdjnOpavVcOCqugEOoCWBAjzQXeg8u_Pe4E3LdoPzrHXEFmLUrdgjPmcMmMw7G55glOQdlXJXBfF3wG9ht3eBVTG1Z1WMJOP17dJiIz_7Cz23xWY971Mb6baxTNIBdSkTjFNSQ3QeZcd2Qi0YHjAZWW0KhfWmgxfMzrEOgrba8hp8hnE1y_eLn7MPe6gvF39hV0oppcOvb4CmoRPBCDiqW-KMoyCtUkFbIXPUbPsJjwuwcpTPmMicGnEYgTR1U2smAL3sylphbCDhuEher">på challonge her</a>.</p>
          <h4>Metal Slug highscore attack</h4>
          <p>Gjengen kjører også i gang et highscore attack i Metal Slug med noen fete premier!</p>
        </div>
      </div>
    </div>
  </Layout>
