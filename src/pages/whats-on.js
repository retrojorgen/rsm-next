  ...
  <Layout>
    ...
    <PageWrap background={Background}>
      <ContentWrap>
        ...
        <p>
          På Retrospillmessen finner alle noe de synes er gøy. Fra Retrospill,
          til shopping, indiespill, foredrag og Q&As, moderne gaming, og til og
          med roboter.
        </p>
      </ContentWrap>
      <FlexWrap>
        <div>
          ...
          >
            <p>
              ...
              Retrospillenes rike historie, helt fra Atari 2600 på 70-tallet,
              den første Nintendoen, obskure maskiner som Atari Jaguar, og
              kjente og kjære Nintendo 64.
            </p>
            <p>
          ...
          >
            <p>
              Er gamle datamaskiner din greie skal du vite at få andre steder
              ser du fler maskiner fra datamaskinenes historie.
            </p>
            <p>
          ...
          >
            <p>
              På Retrospillmessen er hele familien velkommen, og vi har hauger
              av artige aktiviteter for alle aldre. Hos oss finner du et eget
              område for barneaktiviteter, hvor vi perler, gir ansiktsmaling,
              spiller Minecraft, lærer å tegne og mye mer.
            </p>
            <p>
          ...
          >
            <p>
              Det bugner over av spennende utstillinger på Retrospillmessen.
              Ikke bare stiller vi ut sjeldne retrospill og maskiner, men du
              finner også sjeldne leker og til og med LEGO.
            </p>
            <p>
